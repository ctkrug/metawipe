...
- [x] **A1 — Drop/browse a JPEG onto the light-table** *(the wow moment)*
...
- [x] **A2 — Parse EXIF/TIFF/GPS from raw bytes**
...
- [x] **A3 — Convert GPS to a decimal coordinate + map link**
...
- [x] **A4 — Leak panel with live counter and sensitive flags**
...
- [x] **B1 — Lossless strip of metadata segments**
...
- [x] **B2 — Wipe action + download clean file**
